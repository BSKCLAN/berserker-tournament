...
export default function BerserkerProducerPanel() {
  ...
  return (
    <div style={{ backgroundColor: '#1a3a52', color: 'white', padding: '20px', minHeight: '100vh' }}>
      <h1 style={{ color: '#00D9FF' }}>⚡ BERSERKER CLAN</h1>
      <p>TORNEO EN VIVO</p>
      ...
      {mainStream && (
        <div style={{ marginTop: '20px', padding: '20px', backgroundColor: '#0f1e2e', borderRadius: '5px' }}>
